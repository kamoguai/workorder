...
class InstalledReturnDao {
  ...
  static postWorkReply(Map<String, dynamic> jsonMap) async {
    ...
    var res = await HttpManager.netFetch(
        Address.postWorkReply(), paramsData, null, new Options(method: "post"));
  ...
  static getUninstallCode(Map<String, dynamic> jsonMap) async {
    ...
    Map paramsData = {"data": aesData};
    var res = await HttpManager.netFetch(
        Address.getUninstallCode(wkNo: wkNo),
        paramsData,
        null,
  ...
  static getUninstallCodeItem(Map<String, dynamic> jsonMap) async {
    ...
    Map paramsData = {"data": aesData};
    var res = await HttpManager.netFetch(
        Address.getUninstallCodeItem(wkNo: wkNo, unInstallCode: unInstallCode),
        paramsData,
        null,
        new Options(method: "post", contentType: 'application/json'));
    if (res != null && res.result) {
