...
///通用下上刷新控件
class MyNestedPullLoadWidget extends StatefulWidget {
  ///item渲染
  ...
  @override
  _MyNestedPullLoadWidgetState createState() => _MyNestedPullLoadWidgetState(
      this.control,
      this.itemBuilder,
      this.onRefresh,
      this.onLoadMore,
...
class _MyNestedPullLoadWidgetState extends State<MyNestedPullLoadWidget> {
  final IndexedWidgetBuilder itemBuilder;
  ...
  _MyNestedPullLoadWidgetState(this.control, this.itemBuilder, this.onRefresh,
